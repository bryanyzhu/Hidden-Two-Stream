...
def main():
    ...
    model_file = '../logs_end/ucf101_split2_vgg16_hidden.caffemodel'
    spatial_net = caffe.Net(model_def_file, model_file, caffe.TEST)

    val_file = "./testlist02_with_labels.txt"
    ...
    sio.savemat("./split2_hidden_end_before_26k.mat", spatial_results_before)
    sio.savemat("./split2_hidden_end_26k.mat", spatial_results)
