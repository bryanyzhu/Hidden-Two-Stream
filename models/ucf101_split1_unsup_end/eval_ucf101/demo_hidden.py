...
def main():
    ...
    model_file = '../logs_end/ucf101_split1_vgg16_hidden.caffemodel'
    ...
    sio.savemat("./split1_hidden_end_before.mat", spatial_results_before)
    sio.savemat("./split1_hidden_end.mat", spatial_results)
