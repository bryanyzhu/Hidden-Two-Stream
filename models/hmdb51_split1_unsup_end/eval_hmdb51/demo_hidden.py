...
def main():
    ...
    model_file = '../logs_end/hmdb51_split1_vgg16_hidden.caffemodel'
    FRAME_PATH = "TODO"
    spatial_net = caffe.Net(model_def_file, model_file, caffe.TEST)

    val_file = "./testlist01.txt"
    ...
    sio.savemat("./hmdb51_split1_hidden_before.mat", spatial_results_before)
    sio.savemat("./hmdb51_split1_hidden.mat", spatial_results)
