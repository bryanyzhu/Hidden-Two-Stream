#ifndef FLOW_TRANSFORMER_LAYER_HPP_
#define FLOW_TRANSFORMER_LAYER_HPP_
...
class FlowTransformerLayer : public Layer<Dtype> {

public:
	explicit FlowTransformerLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {
	...
	virtual inline const char* type() const { return "FlowTransformer"; }
